...
const STEPS = [
  ...
  {
    number: '03',
    title: 'Isometric Office Updates',
    ascii: [
      '┌──────────────────┐',
      '│ ═══ AI LAB ═══   │',
      '│     ◇◇◇◇         │',
    ...
    description: 'The isometric office animates in real time. Engineers think, code, debug, or build on a dynamic 2.5D diamond-tile floor.',
    color: '#00ff41',
  },
];
...
function HowItWorks() {
  ...
  ┌──────────────┐     hook      ┌──────────────┐     render    ┌──────────────┐
  │              │  ──────────>  │              │  ──────────>  │              │
  │  Claude Code │   pre/post    │   ClaudeLab  │  isometric    │   Terminal   │
